...
try {
    ...
    & "$CompilerRoot/VC/bin/cl.exe" /nologo /W4 /WX /MT /EHsc /O2 /LD /Iinclude /Fobuild/ /Febuild/aicTactics.dll src/runtime.cpp src/lua_module.cpp src/recruitment.cpp src/random.cpp src/shc141_recruitment.cpp src/shc141_groups.cpp /link /MANIFEST:NO kernel32.lib
