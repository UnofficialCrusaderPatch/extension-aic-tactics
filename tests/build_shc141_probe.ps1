...
try {
    ...
    & "$CompilerRoot/VC/bin/cl.exe" /nologo /W4 /WX /MT /EHsc /O2 /D_CRT_SECURE_NO_WARNINGS /Iinclude /Fobuild/ /Febuild/shc141-probe-tests.exe src/shc141_recruitment.cpp tests/shc141_probe_tests.cpp /link /MANIFEST:NO /BASE:0x400000 /FIXED /MERGE:.text=.ztext /MERGE:.rdata=.zrdata /MERGE:.data=.zdata kernel32.lib
